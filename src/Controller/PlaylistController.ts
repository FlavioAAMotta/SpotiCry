...
export class PlaylistController {
  ...
  createPlaylist = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const { songs, description, name, imageURL } = req.body;
      await this.playlistBusiness.createPlaylist(token, songs, description, name, imageURL);
  ...
  updatePlaylist = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      await this.playlistBusiness.updatePlaylist(id, name, description, token, imageURL);
